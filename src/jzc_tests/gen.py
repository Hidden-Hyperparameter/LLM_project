...
# f = open('/ssdshare/2024040125_2023040165_2023040163_project/src/jzc_tests/test.txt', 'w')
# for i in range(50):
#     # generate a random string R
#     R = ''.join(random.choices('abcdefghijklmnopqrstuvwxyz', k=random.randint(5, 15)))
#     file_name = R + ".pdf"
#     tags = random.sample(final_tags, random.randint(3, 10))
#     string = 'File:'+ file_name + ',\ttags: '+ '; '.join(tags)
#     f.write(string + '\n')
import random
f = open('/ssdshare/2024040125_2023040165_2023040163_project/src/jzc_tests/t01.txt', 'w')
for i in range(100000):
    s = ''.join(random.choices('01', k=10))
    f.write(s)
